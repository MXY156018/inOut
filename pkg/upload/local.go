/*
 * @Author: your name
 * @Date: 2022-03-22 16:44:35
 * @LastEditTime: 2022-03-23 14:30:07
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \utils\upload\local.go
 */
package upload
...
func (*Local) UploadFile(file *multipart.FileHeader, localPath string, log *zap.Logger) (string, string, error) {
	// 读取文件后缀
...
//@param: key string
//@return: error
func (*Local) DeleteFile(key string, localPath string, GVA_LOG *zap.Logger) error {
	p := localPath + "/" + key
