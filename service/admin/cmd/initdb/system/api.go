...
const groupPrefix = "[核心]-"

type initApi struct{}

const initOrderApi = logic.InitOrderSystem + 1
...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []model.SysApi{
		{ApiGroup: groupPrefix + "jwt", Method: "POST", Path: "/jwt/jsonInBlacklist", Description: "jwt加入黑名单(退出，必选)"},

		{ApiGroup: groupPrefix + "系统用户", Method: "DELETE", Path: "/user/deleteUser", Description: "删除用户"},
		{ApiGroup: groupPrefix + "系统用户", Method: "POST", Path: "/user/admin_register", Description: "用户注册"},
		{ApiGroup: groupPrefix + "系统用户", Method: "POST", Path: "/user/getUserList", Description: "获取用户列表"},
		{ApiGroup: groupPrefix + "系统用户", Method: "PUT", Path: "/user/setUserInfo", Description: "设置用户信息"},
		{ApiGroup: groupPrefix + "系统用户", Method: "PUT", Path: "/user/setSelfInfo", Description: "设置自身信息(必选)"},
		{ApiGroup: groupPrefix + "系统用户", Method: "GET", Path: "/user/getUserInfo", Description: "获取自身信息(必选)"},
		{ApiGroup: groupPrefix + "系统用户", Method: "POST", Path: "/user/setUserAuthorities", Description: "设置权限组"},
		{ApiGroup: groupPrefix + "系统用户", Method: "POST", Path: "/user/changePassword", Description: "修改密码（建议选择)"},
		{ApiGroup: groupPrefix + "系统用户", Method: "POST", Path: "/user/setUserAuthority", Description: "修改用户角色(必选)"},
		{ApiGroup: groupPrefix + "系统用户", Method: "POST", Path: "/user/resetPassword", Description: "重置用户密码"},

		{ApiGroup: groupPrefix + "api", Method: "POST", Path: "/api/createApi", Description: "创建api"},
		{ApiGroup: groupPrefix + "api", Method: "POST", Path: "/api/deleteApi", Description: "删除Api"},
		{ApiGroup: groupPrefix + "api", Method: "POST", Path: "/api/updateApi", Description: "更新Api"},
		{ApiGroup: groupPrefix + "api", Method: "POST", Path: "/api/getApiList", Description: "获取api列表"},
		{ApiGroup: groupPrefix + "api", Method: "POST", Path: "/api/getAllApis", Description: "获取所有api"},
		{ApiGroup: groupPrefix + "api", Method: "POST", Path: "/api/getApiById", Description: "获取api详细信息"},
		{ApiGroup: groupPrefix + "api", Method: "DELETE", Path: "/api/deleteApisByIds", Description: "批量删除api"},

		{ApiGroup: groupPrefix + "角色", Method: "POST", Path: "/authority/copyAuthority", Description: "拷贝角色"},
		{ApiGroup: groupPrefix + "角色", Method: "POST", Path: "/authority/createAuthority", Description: "创建角色"},
		{ApiGroup: groupPrefix + "角色", Method: "POST", Path: "/authority/deleteAuthority", Description: "删除角色"},
		{ApiGroup: groupPrefix + "角色", Method: "PUT", Path: "/authority/updateAuthority", Description: "更新角色信息"},
		{ApiGroup: groupPrefix + "角色", Method: "POST", Path: "/authority/getAuthorityList", Description: "获取角色列表"},
		{ApiGroup: groupPrefix + "角色", Method: "POST", Path: "/authority/setDataAuthority", Description: "设置角色资源权限"},

		{ApiGroup: groupPrefix + "casbin", Method: "POST", Path: "/casbin/updateCasbin", Description: "更改角色api权限"},
		{ApiGroup: groupPrefix + "casbin", Method: "POST", Path: "/casbin/getPolicyPathByAuthorityId", Description: "获取权限列表"},

		{ApiGroup: groupPrefix + "菜单", Method: "POST", Path: "/menu/addBaseMenu", Description: "新增菜单"},
		{ApiGroup: groupPrefix + "菜单", Method: "POST", Path: "/menu/getMenu", Description: "获取菜单树(必选)"},
		{ApiGroup: groupPrefix + "菜单", Method: "POST", Path: "/menu/deleteBaseMenu", Description: "删除菜单"},
		{ApiGroup: groupPrefix + "菜单", Method: "POST", Path: "/menu/updateBaseMenu", Description: "更新菜单"},
		{ApiGroup: groupPrefix + "菜单", Method: "POST", Path: "/menu/getBaseMenuById", Description: "根据id获取菜单"},
		{ApiGroup: groupPrefix + "菜单", Method: "POST", Path: "/menu/getMenuList", Description: "分页获取基础menu列表"},
		{ApiGroup: groupPrefix + "菜单", Method: "POST", Path: "/menu/getBaseMenuTree", Description: "获取用户动态路由"},
		{ApiGroup: groupPrefix + "菜单", Method: "POST", Path: "/menu/getMenuAuthority", Description: "获取指定角色menu"},
		{ApiGroup: groupPrefix + "菜单", Method: "POST", Path: "/menu/addMenuAuthority", Description: "增加menu和角色关联关系"},
	...
	if err := db.Create(&entities).Error; err != nil {
		return ctx, errors.Wrap(err, model.SysApi{}.TableName()+"表数据初始化失败!")
	}
...
func (i *initApi) DataInserted(ctx context.Context) bool {
	...
	if errors.Is(db.Where("path = ? AND method = ?", "/user/getUserInfo", "GET").
		First(&model.SysApi{}).Error, gorm.ErrRecordNotFound) {
		return false
	}
	return true
}
